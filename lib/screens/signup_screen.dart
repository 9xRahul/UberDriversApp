...
import 'package:uberdriverapp/widgets/custom_text_field.dart';
import 'package:uberdriverapp/widgets/loading_dialog.dart';
import 'package:uberdriverapp/widgets/snackbar.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  signupFormValidation() {
    ...
    if (name.isEmpty || phone.isEmpty || email.isEmpty || password.isEmpty || model.isEmpty || color.isEmpty || number.isEmpty || selectedCarType == null) {
  ...
  signUpDriverNow() async {
    ...
    try{
      ...
      FirebaseDatabase.instance.ref().child("allDrivers").child(fbUser.uid).set(driverInfo);
                ...
                child: Column(
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: ["SportsCar", "CarSUV", "CarXL", "CarX",].map((carType){
                    ...
                    ElevatedButton(
                      ...
                      child: const Text(
                          "SignUp",
                          style: TextStyle(color: Colors.white, fontFamily: 'MontserratBold',)
                      ),
                    ),
